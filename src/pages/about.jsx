    ...
    <div className="about-container">
      <div className="about-intro">
        ...
        <p className="about-details">
          ...
          allow me to adapt and excel in any project that aligns with my interests and background. With my 
          skills and passion, I am excited to make a positive impact in any organization and work towards 
